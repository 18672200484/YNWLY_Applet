...
namespace CMCS.Common.Entities.TrainInFactory
{
    ...
    public class CmcsTrainWeightRecord : EntityBase1
    {
        ...
        /// 实际皮重(吨)
        /// </summary>
        public Decimal SkinWeight_Real { get; set; }
        ...
        /// 实际净重(吨)
        /// </summary>
        public Decimal StandardWeight_Real { get; set; }
        ...
        /// 是否同步皮重
        /// </summary>
        public Int32 IsSyncTareWeight { get; set; }

        /// <summary>
        /// 方向
        /// </summary>
        [CMCS.DapperDber.Attrs.DapperIgnore]
        public virtual String InFactoryDirection { get; set; }

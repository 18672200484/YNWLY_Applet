...
namespace CMCS.Common.DAO
{
    ...
    public class QCJXCYSamplerDAO
    {
        ...
        public bool CanSendSampleUnloadCmd(string machineCode, out string message)
        {
            ...
            if (GetQCJXCYSamplerSystemStatue(machineCode) != eEquInfSamplerSystemStatus.就绪待机.ToString() && GetQCJXCYSamplerSystemStatue(machineCode) != eEquInfSamplerSystemStatus.采样完成.ToString())
            {
                message = "采样机系统未就绪";
                return false;
            }

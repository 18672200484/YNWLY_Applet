...
namespace CMCS.Common.DAO
{
    ...
    public class BeltSamplerDAO
    {
        ...
        {
            return CommonDAO.GetInstance().GetSignalDataValue(machineCode, eSignalDataName.设备状态.ToString());
        }
        ...
        /// <returns></returns>
        public List<View_RCSampling> GetViewRCSampling(string strWhere, object param = null)
        {
            return Dbers.GetInstance().SelfDber.Entities<View_RCSampling>(strWhere, param);
        }
        ...
        /// <param name="strWhere">查询条件</param>
        /// <returns></returns>
        public List<View_CCSampling> GetViewCCSampling(string strWhere)
        {
            return Dbers.GetInstance().SelfDber.Entities<View_CCSampling>(strWhere);
        }

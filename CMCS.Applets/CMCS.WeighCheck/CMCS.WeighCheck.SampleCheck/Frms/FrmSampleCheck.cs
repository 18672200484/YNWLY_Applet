            ...
            try
            {
                switch (this.CurrentFlowFlag)
                {
                    ...
                    case eFlowFlag.等待校验:
                        ...
                        if (czyHandlerDAO.UpdateRCSampleBarrelCheckSampleWeight(this.rCSampleBarrel.Id, wber.Weight, SelfVars.LoginUser.UserName))
                        {
                ...
                if (this.rCSampleBarrel != null)
                {
                    if (!this.IsScanedRCSampleBarrelId.Contains(this.rCSampleBarrel.Id))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                CmcsSampleBarrel entity = Dbers.GetInstance().SelfDber.Entity<CmcsSampleBarrel>(" where BarrelCode='" + item.BarrelCode + "' ");
                                if (entity != null)
                                {
                                    entity.IsUse = 0;

...
{
    Font FontContent = new Font("微软雅黑", 12, FontStyle.Regular, GraphicsUnit.Pixel);
    ...
    void prtdoc_PrintPage(object sender, PrintPageEventArgs e)
    {
        if (_listCode != null)
        {
            if (_listCode.Count > 0)
            {
                ...
                g.DrawString(_listCode[PageIndex], FontContent, Brushes.Black, new PointF(90 + (140 - titleWidth) / 2, 100));

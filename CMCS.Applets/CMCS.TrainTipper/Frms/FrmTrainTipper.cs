    ...
    public partial class FrmTrainTipper : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void CreateMainTask()
        {
            ...
            taskSimpleScheduler.StartNewTask("翻车业务逻辑", () =>
            {
                ...
                if (inTrainCarriagePass != null)
                {
                    ...
                    // 检测采样机系统的状态
                    string samplerSystemStatue = commonDAO.GetSignalDataValue(this.trainBeltSampler.EquipmentCode, eSignalDataName.设备状态.ToString());
        ...
        private void UpdateLinkBeltSamplerStatus()
        {
            ...
            if (trainBeltSampler != null)
            {
                ...
                string systemStatus = commonDAO.GetSignalDataValue(this.trainBeltSampler.EquipmentCode, eSignalDataName.设备状态.ToString());
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            ...
            if (trainTippers.Count < 2) { MessageBoxEx.Show("启动异常！"); };

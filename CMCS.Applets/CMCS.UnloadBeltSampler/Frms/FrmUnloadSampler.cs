    ...
    public partial class FrmUnloadSampler : MetroForm
    {
        ...
        private void SendSamplerUnloadCmd()
        {
            ...
            taskSimpleScheduler.StartNewTask("卸样业务逻辑", () =>
            {
                ...
                {
                    #region 启动制样进料皮带
                    if (beltSamplerDAO.SendPDUnLoadCmd(this.currentSampler.EquipmentCode, "开始卸料"))
                    {
                ...
                #region 停止制样机进料皮带
                if (beltSamplerDAO.SendPDUnLoadCmd(this.currentSampler.EquipmentCode, "停止卸料"))//卸样完成后 卸料皮带停止
                {

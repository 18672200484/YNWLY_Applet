...
namespace CMCS.Monitor.Win.Frms
{
	public partial class FrmOutBeltSampler : MetroForm
	{
		...
		void RequestData()
		{
			...
			datas.Clear();
			getPDCYJ(commonDAO, ref value, GlobalVars.MachineCode_OutPDCYJ_1, datas, "皮带采样机3");

			getPDCYJ(commonDAO, ref value, GlobalVars.MachineCode_OutPDCYJ_2, datas, "皮带采样机4");

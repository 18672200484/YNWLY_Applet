...
namespace CMCS.Monitor.Win.Core
{
    public class PreviewCarBmp
    {
        ...
        public Bitmap GetPreviewBitmap(Bitmap bCar, int imageWidth, int imageHeight)
        {
            ...
            //图片车头长 需固定
            float CarriageHeadLength = 0f;
            // 车厢宽
            float carriageWidth = 89f;
            ...
            Font obstacleFont = new Font("微软雅黑", 10, FontStyle.Regular);
            if (this.CurrTruck.LeftObstacle1 > 0 && this.CurrTruck.RightObstacle1 > 0)
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle1.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle1 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle1.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle1 - 11, padding + carriageWidth + yOffest);
            ...
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle2.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle2 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle2.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle2 - 11, padding + carriageWidth + yOffest);
            ...
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle3.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle3 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle3.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle3 - 11, padding + carriageWidth + yOffest);
            ...
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle4.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle4 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle4.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle4 - 11, padding + carriageWidth + yOffest);
            ...
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle5.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle5 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle5.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle5 - 11, padding + carriageWidth + yOffest);
            ...
            {
                g.DrawString(this.CurrTruck.RightFromTailObstacle6.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - rightFromTailObstacle6 - 18, padding + yOffest - 20);
                g.DrawString(this.CurrTruck.LeftFromTailObstacle6.ToString(), obstacleFont, Brushes.Red, padding + xOffest + truckTotalLength - leftFromTailObstacle6 - 11, padding + carriageWidth + yOffest);

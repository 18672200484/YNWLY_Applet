...
namespace CMCS.Monitor.Win.Utilities
{
    ...
    public class SuperTabControlManager
    {
        ...
        public void CreateTab(string tabName, string uniqueKey, Form form, bool isFill)
        {
            ...
            if (superTabItem == null)
            {
                ...
                superTabItem.CloseButtonVisible = false;
                ...
                superTabControlPanel.PanelColor.Default = new SuperTabPanelItemColorTable()
                {
                    ...
                    {
                        Colors = new Color[] { ColorTranslator.FromHtml("#2B2E33") }
                    }
                };

namespace CMCS.CarTransport.RCBeltSampler.Frms
{
    partial class FrmBeltSampler
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cmbGatherType = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			...
			gridColumn25.DataPropertyName = "Batch";
			gridColumn25.HeaderText = "入厂批次号";
			gridColumn25.Name = "";
			gridColumn25.Width = 120;
			gridColumn26.AutoSizeMode = DevComponents.DotNetBar.SuperGrid.ColumnAutoSizeMode.AllCells;
			gridColumn26.DataPropertyName = "SupplierName";
			gridColumn26.HeaderText = "供应商名称";
			gridColumn26.Name = "";
			gridColumn26.Width = 150;
			gridColumn27.DataPropertyName = "MineName";
			gridColumn27.HeaderText = "矿点名称";
			gridColumn27.Name = "";
			gridColumn28.DataPropertyName = "FuelName";
			gridColumn28.HeaderText = "煤种名称";
			gridColumn28.Name = "";
			gridColumn29.DataPropertyName = "SamplingDate";
			gridColumn29.HeaderText = "采样日期";
			gridColumn29.Name = "";
			gridColumn29.Width = 140;
			gridColumn30.AutoSizeMode = DevComponents.DotNetBar.SuperGrid.ColumnAutoSizeMode.AllCells;
			gridColumn30.DataPropertyName = "SampleCode";
			gridColumn30.HeaderText = "采样码";
			gridColumn30.Name = "";
			gridColumn31.DataPropertyName = "SamplingType";
			gridColumn31.HeaderText = "采样方式";
			gridColumn31.Name = "";
			gridColumn31.Width = 80;
			background3.Color1 = System.Drawing.Color.DarkTurquoise;
			gridColumn32.CellStyles.Default.Background = background3;
			gridColumn32.CellStyles.Default.TextColor = System.Drawing.Color.DarkTurquoise;
			gridColumn32.EditorType = typeof(DevComponents.DotNetBar.SuperGrid.GridButtonXEditControl);
			gridColumn32.HeaderText = "";
			gridColumn32.Name = "gclmSetSampler";
			gridColumn32.NullString = "设置为当前采样单";
			gridColumn32.Width = 150;
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn25);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn26);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn27);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn28);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn29);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn30);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn31);
			this.superGridControl2.PrimaryGrid.Columns.Add(gridColumn32);
			...
			this.superTabItem1.Text = "出 入 场 批 次 信 息";
			// 
			...
			this.panelEx6.Controls.Add(this.cmbGatherType);
			...
			// cmbGatherType
			// 
			this.cmbGatherType.DisplayMember = "Text";
			this.cmbGatherType.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
			this.cmbGatherType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cmbGatherType.Font = new System.Drawing.Font("Segoe UI", 10F);
			this.cmbGatherType.ForeColor = System.Drawing.Color.White;
			this.cmbGatherType.FormattingEnabled = true;
			this.cmbGatherType.ItemHeight = 19;
			this.cmbGatherType.Location = new System.Drawing.Point(95, 75);
			this.cmbGatherType.Name = "cmbGatherType";
			this.cmbGatherType.Size = new System.Drawing.Size(92, 25);
			this.cmbGatherType.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.cmbGatherType.TabIndex = 41;
			this.cmbGatherType.SelectedIndexChanged += new System.EventHandler(this.cmbGatherType_SelectedIndexChanged);
			// 
			// btnStartSampler
			// 
			...
			this.lblSupplierName.Location = new System.Drawing.Point(130, 107);
			...
			this.label112.Size = new System.Drawing.Size(105, 19);
			this.label112.TabIndex = 19;
			this.label112.Text = "批     次     号：";
			// 
			// lblFactarriveDate
			// 
			...
			this.lblFactarriveDate.Location = new System.Drawing.Point(130, 77);
			...
			gridColumn33.CellStyles.Default.Alignment = DevComponents.DotNetBar.SuperGrid.Style.Alignment.MiddleCenter;
			gridColumn33.DataPropertyName = "BarrelNumber";
			gridColumn33.HeaderText = "罐号";
			gridColumn33.MinimumWidth = 50;
			gridColumn33.Name = "";
			gridColumn33.Width = 60;
			gridColumn34.CellStyles.Default.Alignment = DevComponents.DotNetBar.SuperGrid.Style.Alignment.MiddleCenter;
			gridColumn34.DataPropertyName = "SampleCode";
			gridColumn34.HeaderText = "采样副码";
			gridColumn34.MinimumWidth = 100;
			gridColumn34.Name = "";
			gridColumn34.Width = 120;
			gridColumn35.CellStyles.Default.Alignment = DevComponents.DotNetBar.SuperGrid.Style.Alignment.MiddleCenter;
			gridColumn35.DataPropertyName = "SampleCount";
			gridColumn35.HeaderText = "子样数";
			gridColumn35.MinimumWidth = 80;
			gridColumn35.Name = "";
			gridColumn36.CellStyles.Default.Alignment = DevComponents.DotNetBar.SuperGrid.Style.Alignment.MiddleCenter;
			gridColumn36.DataPropertyName = "BarrelStatus";
			gridColumn36.HeaderText = "桶满";
			gridColumn36.MinimumWidth = 60;
			gridColumn36.Name = "";
			...
			this.superTabItem_BuyFuel.Text = "出 入 厂 皮 带 采 样";
			// 
        ...
        private DevComponents.DotNetBar.Controls.ComboBoxEx cmbGatherType;
    }
}
...
namespace CMCS.CarTransport.Weighter.Core
{
	...
	public class Hardwarer
	{
		...
		/// LED屏1
		/// </summary>
		static LEDListenAreaLeder ledListenCYJ1 = new LEDListenAreaLeder();
		public static LEDListenAreaLeder LedListenCYJ1
		{
			get { return ledListenCYJ1; }
		}

		/// <summary>
		/// LED屏2
		/// </summary>
		static LEDListenAreaLeder ledListenCYJ2 = new LEDListenAreaLeder();
		public static LEDListenAreaLeder LedListenCYJ2
		{
			get { return ledListenCYJ2; }
		}
	}
}

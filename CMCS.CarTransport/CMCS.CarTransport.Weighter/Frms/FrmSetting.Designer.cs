namespace CMCS.CarTransport.Weighter.Frms
{
    partial class FrmSetting
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cmbInFactoryType = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			this.comboItem1 = new DevComponents.Editors.ComboItem();
			this.comboItem2 = new DevComponents.Editors.ComboItem();
			this.txtSelfConnStr = new DevComponents.DotNetBar.Controls.TextBoxX();
			this.labelX20 = new DevComponents.DotNetBar.LabelX();
			this.chbBothWay = new DevComponents.DotNetBar.Controls.CheckBoxX();
			...
			this.cmbInfraredSensor2Port = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			this.labelX12 = new DevComponents.DotNetBar.LabelX();
			this.cmbInfraredSensor1Port = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			...
			this.iptxtRwer2 = new DevComponents.Editors.IpAddressInput();
			this.iptxtRwer1 = new DevComponents.Editors.IpAddressInput();
			...
			this.dbtxtSteady = new DevComponents.Editors.DoubleInput();
			this.dbtxtGrossLossTare = new DevComponents.Editors.DoubleInput();
			...
			this.cmbLEDType = new DevComponents.DotNetBar.Controls.ComboBoxEx();
			...
			((System.ComponentModel.ISupportInitialize)(this.iptxtRwer2)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.iptxtRwer1)).BeginInit();
			this.tabControlPanel3.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dbtxtSteady)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dbtxtGrossLossTare)).BeginInit();
			...
			// tabControlPanel1
			// 
			this.tabControlPanel1.Controls.Add(this.labelX33);
			this.tabControlPanel1.Controls.Add(this.cmbInFactoryType);
			this.tabControlPanel1.Controls.Add(this.txtSelfConnStr);
			this.tabControlPanel1.Controls.Add(this.labelX20);
			this.tabControlPanel1.Controls.Add(this.chbBothWay);
			...
			this.labelX33.Location = new System.Drawing.Point(380, 135);
			this.labelX33.Name = "labelX33";
			this.labelX33.Size = new System.Drawing.Size(198, 23);
			this.labelX33.TabIndex = 25;
			this.labelX33.Text = "*默认过磅类型";
			// 
			// cmbInFactoryType
			// 
			this.cmbInFactoryType.DisplayMember = "Text";
			this.cmbInFactoryType.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
			this.cmbInFactoryType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cmbInFactoryType.Font = new System.Drawing.Font("Segoe UI", 12F);
			this.cmbInFactoryType.ForeColor = System.Drawing.Color.White;
			this.cmbInFactoryType.FormattingEnabled = true;
			this.cmbInFactoryType.ItemHeight = 23;
			this.cmbInFactoryType.Items.AddRange(new object[] {
            this.comboItem1,
            this.comboItem2});
			this.cmbInFactoryType.Location = new System.Drawing.Point(167, 130);
			this.cmbInFactoryType.Name = "cmbInFactoryType";
			this.cmbInFactoryType.Size = new System.Drawing.Size(180, 29);
			this.cmbInFactoryType.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.cmbInFactoryType.TabIndex = 21;
			// 
			// comboItem1
			// 
			this.comboItem1.Text = "入厂煤";
			// 
			// comboItem2
			// 
			this.comboItem2.Text = "销售煤";
			// 
			// txtSelfConnStr
			// 
			...
			// chbBothWay
			// 
			this.chbBothWay.AutoSize = true;
			this.chbBothWay.BackColor = System.Drawing.Color.Transparent;
			// 
			// 
			// 
			this.chbBothWay.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.chbBothWay.Font = new System.Drawing.Font("Segoe UI", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.chbBothWay.ForeColor = System.Drawing.Color.White;
			this.chbBothWay.Location = new System.Drawing.Point(292, 105);
			this.chbBothWay.Name = "chbBothWay";
			this.chbBothWay.Size = new System.Drawing.Size(76, 24);
			this.chbBothWay.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.chbBothWay.TabIndex = 18;
			this.chbBothWay.Text = "双向磅";
			// 
			// chbStartup
			// 
			...
			this.tabControlPanel2.Controls.Add(this.cmbInfraredSensor2Port);
			this.tabControlPanel2.Controls.Add(this.labelX12);
			this.tabControlPanel2.Controls.Add(this.cmbInfraredSensor1Port);
			...
			// 
			// cmbInfraredSensor2Port
			// 
			this.cmbInfraredSensor2Port.DisplayMember = "Text";
			...
			this.cmbInfraredSensor2Port.Name = "cmbInfraredSensor2Port";
			this.cmbInfraredSensor2Port.Size = new System.Drawing.Size(92, 27);
			this.cmbInfraredSensor2Port.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.cmbInfraredSensor2Port.TabIndex = 38;
			// 
			// labelX12
			// 
			...
			this.labelX12.Text = "对射2端口";
			// 
			// cmbInfraredSensor1Port
			// 
			this.cmbInfraredSensor1Port.DisplayMember = "Text";
			...
			this.cmbInfraredSensor1Port.Name = "cmbInfraredSensor1Port";
			this.cmbInfraredSensor1Port.Size = new System.Drawing.Size(92, 27);
			this.cmbInfraredSensor1Port.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.cmbInfraredSensor1Port.TabIndex = 36;
			// 
			// labelX13
			// 
			...
			// tabControlPanel4
			// 
			this.tabControlPanel4.Controls.Add(this.iptxtRwer2);
			this.tabControlPanel4.Controls.Add(this.iptxtRwer1);
			...
			// iptxtRwer2
			// 
			this.iptxtRwer2.AutoOverwrite = true;
			this.iptxtRwer2.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(47)))), ((int)(((byte)(51)))));
			// 
			// 
			// 
			this.iptxtRwer2.BackgroundStyle.Class = "DateTimeInputBackground";
			this.iptxtRwer2.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.iptxtRwer2.ButtonFreeText.Shortcut = DevComponents.DotNetBar.eShortcut.F2;
			this.iptxtRwer2.ButtonFreeText.Visible = true;
			this.iptxtRwer2.ForeColor = System.Drawing.Color.White;
			this.iptxtRwer2.Location = new System.Drawing.Point(231, 67);
			this.iptxtRwer2.Name = "iptxtRwer2";
			this.iptxtRwer2.Size = new System.Drawing.Size(185, 27);
			this.iptxtRwer2.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.iptxtRwer2.TabIndex = 43;
			// 
			// iptxtRwer1
			// 
			this.iptxtRwer1.AutoOverwrite = true;
			this.iptxtRwer1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(47)))), ((int)(((byte)(51)))));
			// 
			// 
			// 
			this.iptxtRwer1.BackgroundStyle.Class = "DateTimeInputBackground";
			this.iptxtRwer1.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.iptxtRwer1.ButtonFreeText.Shortcut = DevComponents.DotNetBar.eShortcut.F2;
			this.iptxtRwer1.ButtonFreeText.Visible = true;
			this.iptxtRwer1.ForeColor = System.Drawing.Color.White;
			this.iptxtRwer1.Location = new System.Drawing.Point(231, 16);
			this.iptxtRwer1.Name = "iptxtRwer1";
			this.iptxtRwer1.Size = new System.Drawing.Size(185, 27);
			this.iptxtRwer1.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.iptxtRwer1.TabIndex = 43;
			// 
			// labelX21
			// 
			...
			this.labelX21.Location = new System.Drawing.Point(122, 69);
			this.labelX21.Name = "labelX21";
			this.labelX21.Size = new System.Drawing.Size(113, 24);
			this.labelX21.TabIndex = 31;
			this.labelX21.Text = "车号识别2地址";
			// 
			// labelX28
			// 
			...
			this.labelX28.Location = new System.Drawing.Point(122, 19);
			this.labelX28.Name = "labelX28";
			this.labelX28.Size = new System.Drawing.Size(113, 24);
			this.labelX28.TabIndex = 27;
			this.labelX28.Text = "车号识别1地址";
			// 
			// tabItem4
			// 
			this.tabItem4.AttachedControl = this.tabControlPanel4;
			this.tabItem4.Name = "tabItem4";
			this.tabItem4.Text = "车号识别";
			// 
			// tabControlPanel3
			// 
			this.tabControlPanel3.Controls.Add(this.cmbWberParity);
			this.tabControlPanel3.Controls.Add(this.labelX3);
			this.tabControlPanel3.Controls.Add(this.dbtxtSteady);
			this.tabControlPanel3.Controls.Add(this.dbtxtGrossLossTare);
			...
			// dbtxtSteady
			// 
			this.dbtxtSteady.AllowEmptyState = false;
			this.dbtxtSteady.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(47)))), ((int)(((byte)(51)))));
			// 
			// 
			// 
			this.dbtxtSteady.BackgroundStyle.Class = "DateTimeInputBackground";
			this.dbtxtSteady.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.dbtxtSteady.ButtonFreeText.Shortcut = DevComponents.DotNetBar.eShortcut.F2;
			this.dbtxtSteady.ForeColor = System.Drawing.Color.White;
			this.dbtxtSteady.Increment = 1D;
			this.dbtxtSteady.Location = new System.Drawing.Point(167, 151);
			this.dbtxtSteady.MaxValue = 10D;
			this.dbtxtSteady.MinValue = 0D;
			this.dbtxtSteady.Name = "dbtxtSteady";
			this.dbtxtSteady.Size = new System.Drawing.Size(92, 27);
			this.dbtxtSteady.TabIndex = 45;
			// 
			// dbtxtGrossLossTare
			// 
			this.dbtxtGrossLossTare.AllowEmptyState = false;
			this.dbtxtGrossLossTare.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(47)))), ((int)(((byte)(51)))));
			// 
			// 
			// 
			this.dbtxtGrossLossTare.BackgroundStyle.Class = "DateTimeInputBackground";
			this.dbtxtGrossLossTare.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.dbtxtGrossLossTare.ButtonFreeText.Shortcut = DevComponents.DotNetBar.eShortcut.F2;
			this.dbtxtGrossLossTare.ForeColor = System.Drawing.Color.White;
			this.dbtxtGrossLossTare.Increment = 1D;
			this.dbtxtGrossLossTare.Location = new System.Drawing.Point(465, 149);
			this.dbtxtGrossLossTare.MaxValue = 100D;
			this.dbtxtGrossLossTare.MinValue = 0D;
			this.dbtxtGrossLossTare.Name = "dbtxtGrossLossTare";
			this.dbtxtGrossLossTare.Size = new System.Drawing.Size(92, 27);
			this.dbtxtGrossLossTare.TabIndex = 45;
			// 
			// dbtxtMinWeight
			// 
			...
			this.labelX22.Location = new System.Drawing.Point(66, 153);
			this.labelX22.Name = "labelX22";
			this.labelX22.Size = new System.Drawing.Size(98, 24);
			this.labelX22.TabIndex = 43;
			this.labelX22.Text = "稳定时间(秒)";
			// 
			// labelX29
			// 
			...
			this.labelX29.Location = new System.Drawing.Point(402, 151);
			this.labelX29.Name = "labelX29";
			this.labelX29.Size = new System.Drawing.Size(56, 24);
			this.labelX29.TabIndex = 43;
			this.labelX29.Text = "毛皮差";
			// 
			// labelX23
			// 
			...
			// tabControlPanel5
			// 
			this.tabControlPanel5.Controls.Add(this.cmbLEDType);
			this.tabControlPanel5.Controls.Add(this.labelX34);
			...
			// cmbLEDType
			// 
			this.cmbLEDType.DisplayMember = "Text";
			this.cmbLEDType.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
			this.cmbLEDType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cmbLEDType.Font = new System.Drawing.Font("Segoe UI", 12F);
			this.cmbLEDType.ForeColor = System.Drawing.Color.White;
			this.cmbLEDType.FormattingEnabled = true;
			this.cmbLEDType.ItemHeight = 23;
			this.cmbLEDType.Items.AddRange(new object[] {
            this.comboItem3,
            this.comboItem4});
			this.cmbLEDType.Location = new System.Drawing.Point(167, 110);
			this.cmbLEDType.Name = "cmbLEDType";
			this.cmbLEDType.Size = new System.Drawing.Size(180, 29);
			this.cmbLEDType.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
			this.cmbLEDType.TabIndex = 45;
			// 
			// comboItem3
			// 
			this.comboItem3.Text = "入厂煤";
			// 
			// comboItem4
			// 
			this.comboItem4.Text = "销售煤";
			// 
			// labelX34
			// 
			...
			this.labelX34.Location = new System.Drawing.Point(74, 115);
			this.labelX34.Name = "labelX34";
			this.labelX34.Size = new System.Drawing.Size(88, 24);
			this.labelX34.TabIndex = 44;
			this.labelX34.Text = "控制卡类型";
			// 
			// FrmSetting
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.iptxtRwer2)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.iptxtRwer1)).EndInit();
			this.tabControlPanel3.ResumeLayout(false);
			this.tabControlPanel3.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dbtxtSteady)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dbtxtGrossLossTare)).EndInit();
        ...
        private DevComponents.DotNetBar.Controls.ComboBoxEx cmbInfraredSensor2Port;
        private DevComponents.DotNetBar.LabelX labelX12;
        private DevComponents.DotNetBar.Controls.ComboBoxEx cmbInfraredSensor1Port;
        ...
        private DevComponents.Editors.IpAddressInput iptxtRwer1;
        private DevComponents.Editors.IpAddressInput iptxtRwer2;
        private DevComponents.DotNetBar.Controls.CheckBoxX chbBothWay;
        private DevComponents.Editors.DoubleInput dbtxtSteady;
        private DevComponents.DotNetBar.LabelX labelX22;
        private DevComponents.Editors.DoubleInput dbtxtGrossLossTare;
        private DevComponents.DotNetBar.LabelX labelX29;
        private DevComponents.DotNetBar.Controls.ComboBoxEx cmbInFactoryType;
        private DevComponents.Editors.ComboItem comboItem1;
        private DevComponents.Editors.ComboItem comboItem2;
        private DevComponents.DotNetBar.LabelX labelX31;
        private DevComponents.DotNetBar.LabelX labelX33;
		private DevComponents.DotNetBar.Controls.ComboBoxEx cmbLEDType;
